...
#RF Model:
set.seed(2001)
df2_RF <- randomForest(as.factor(type)~., #Sets what the response variable and the predictors are. The period means to consider all other variables
...
df2_roc <- roc(df_predict$aggregate, as.numeric(df_test$type), plot = TRUE)
```
